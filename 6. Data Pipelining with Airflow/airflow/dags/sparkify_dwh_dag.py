...
dag = DAG('sparkify_music_dwh_dag',
          default_args=default_args,
          description='Load and transform data in Redshift Data Warehouse with Airflow',
...
run_quality_checks = DataQualityOperator(
    ...
    dag=dag,
    redshift_conn_id="redshift",
    table_names=["public.staging_events", "public.staging_songs", "public.songplays",
                 "public.artists", "public.songs", "public.time", "public.users"]
)
